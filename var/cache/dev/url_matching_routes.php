...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/deck/shuffle' => [[['_route' => 'api_shuffle', '_controller' => 'App\\Controller\\CardsController::apiShuffle'], null, ['GET' => 0], null, false, false, null]],
        '/api/deck/draw' => [[['_route' => 'api_draw', '_controller' => 'App\\Controller\\CardsController::apiDraw'], null, ['GET' => 0], null, false, false, null]],
        ...
        '/api/game' => [[['_route' => 'api_game', '_controller' => 'App\\Controller\\GameController::apiDrawMultiple'], null, ['GET' => 0], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        218 => [
            [['_route' => 'api_draw_multiple', '_controller' => 'App\\Controller\\CardsController::apiDrawMultiple'], ['num'], ['GET' => 0], null, false, true, null],
